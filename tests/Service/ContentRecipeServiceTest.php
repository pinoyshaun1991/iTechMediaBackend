...
"text": "Enjoy!"
    ...
    public function testGetRawRecipeContent(): void
    {
        ...
        $this->assertEquals($this->returnedRecipesString, $mock->getRawRecipeContent('http://18.130.116.85/recipes/raw', array('from' => 0, 'to' => 2), 'application/x-www-form-urlencoded'));
    }
}